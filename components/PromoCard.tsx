  ...
  return (
    <div className="bg-[#FFCC00] rounded-2xl p-3 md:p-4 flex flex-col relative shadow-lg overflow-hidden group border-2 border-yellow-500 hover:shadow-2xl transition-all duration-300 h-full min-h-[380px] md:min-h-[450px]">
      ...
      <div className="w-full relative z-20 mt-4">
          <div className="flex items-stretch bg-red-700 rounded-b-xl h-32 md:h-36 overflow-hidden border-t-[6px] border-black/10 shadow-inner relative">
            
            {/* POR TAG - REPOSICIONADA MAIS PARA CIMA */}
            <div className="absolute top-[25%] left-[40%] -translate-x-1/2 -translate-y-1/2 z-30 transform hover:scale-110 transition-transform duration-300">
              <div className="bg-white text-black font-oswald font-black px-2 md:px-3 py-0.5 md:py-1 rounded-sm text-xs md:text-sm uppercase border-2 border-red-700 shadow-[2px_2px_0px_rgba(185,28,28,1)] whitespace-nowrap">
                Por
              </div>
            </div>
            ...
            <div className="w-3/5 bg-red-700 text-white flex flex-col items-center justify-center p-1 relative">
               ...
               <a 
                 ...
                 className="mt-auto mb-1 flex items-center justify-center bg-green-500 hover:bg-green-600 text-white text-sm md:text-base font-bold py-2.5 md:py-3 px-4 rounded-full shadow-md transition-all hover:scale-105 active:scale-95 w-[96%]"
               >
