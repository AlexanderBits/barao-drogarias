  ...
  return (
    <div className="bg-red-600 rounded-3xl p-6 flex flex-col justify-between items-center relative shadow-2xl overflow-hidden h-full group border-4 border-red-700">
      ...
      <div className="w-full bg-black rounded-t-2xl flex flex-col items-center pt-8 pb-0 px-0 relative mt-auto border-t-[6px] border-yellow-400 shadow-[0_-10px_20px_rgba(0,0,0,0.4)]">
        {/* POR TAG - REPOSICIONADA PARA NÃO ATRAPALHAR O BOTÃO */}
        <div className="absolute top-2 left-[33.3%] -translate-x-1/2 z-30 transform hover:scale-110 transition-transform duration-300">
           <div className="bg-yellow-400 text-black font-oswald font-black px-4 md:px-6 py-0.5 md:py-1 rounded-full text-lg md:text-xl uppercase border-4 border-black shadow-[3px_3px_0px_#000] whitespace-nowrap">
              Por
           </div>
        </div>
            ...
            <div className="flex items-start justify-center -mt-1">
              ...
              <div className="flex flex-col items-start mt-4">
               ...
               <a 
                 ...
                 className="flex items-center justify-center bg-green-600 hover:bg-green-700 text-white text-base md:text-lg font-bold py-2 md:py-3.5 px-6 rounded-full shadow-md transition-all hover:scale-105 active:scale-95 w-[92%] md:w-[85%] uppercase z-10 mb-1"
               >
